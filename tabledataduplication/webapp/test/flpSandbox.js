		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Table Personalization",
									"targetURL": "#tablepersonalize-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tablepersonalize-display": {
								"semanticObject": "tablepersonalize",
								"action": "display",
								"description": "Table Personalization using Northwind",
								"title": "Table Personalization",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tablepersonalize",
									"url": sap.ui.require.toUrl("tablepersonalize")
								}
							}
						}
					}
