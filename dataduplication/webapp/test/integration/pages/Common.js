sap.ui.define([
	...
	return Opa5.extend("dataduplication.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["dataduplication/localService/mockserver"], function (mockserver) {
