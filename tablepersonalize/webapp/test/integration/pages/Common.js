sap.ui.define([
	...
	return Opa5.extend("tablepersonalize.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["tablepersonalize/localService/mockserver"], function (mockserver) {
